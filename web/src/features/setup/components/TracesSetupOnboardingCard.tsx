...
const SKILLS_INSTALL_COMMAND =
  "Install the EvalSight AI skill from github.com/langfuse/skills and use it to add tracing to this application with EvalSight following best practices.";
...
export function TracesSetupOnboardingCard({
  ...
  return (
    <SplashScreen
      ...
      description="Get your API keys first, then ask your coding agent to add observability with EvalSight to your application."
      ...
      steps={[
        {
          ...
          description:
            "Your application needs API keys to send traces to EvalSight.",
          content: apiKeys ? (
            <ApiKeyDetailContent
              scope="project"
