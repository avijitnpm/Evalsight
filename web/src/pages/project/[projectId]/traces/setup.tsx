    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground mb-4 text-sm">
          EvalSight relies on OpenTelemetry to instrument your application and
          export LLM application/agent traces to EvalSight. You can use one of
          our SDKs or 50+ framework integrations. Please follow the quickstart
          in the documentation to add EvalSight to your application.
        </p>
  ...
  return (
    <ContainerPage
      headerProps={{
        ...
        help: {
          description:
            "Setup tracing to track and analyze your LLM calls. You can create API keys and integrate EvalSight with your application.",
