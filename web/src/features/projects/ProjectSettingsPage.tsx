      ...
      <div className="space-y-6">
        <Card className="p-3">
          ...
          <p className="text-primary mb-4 text-sm">
            ...
            EvalSight Events/Metrics available in your Posthog Dashboards.
          </p>
        ...
        <Card className="p-3">
          ...
          <p className="text-primary mb-4 text-sm">
            Integrate with Mixpanel to sync your EvalSight traces, generations,
        ...
        <Card className="p-3">
          ...
          <p className="text-primary mb-4 text-sm">
            ...
            EvalSight alerts natively in Slack.
          </p>
          <div className="flex items-center gap-2">
            <ActionButton
              variant="secondary"
