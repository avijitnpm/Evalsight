  ...
  return (
    <Page
      ...
      headerProps={{
        ...
        help: {
          description:
            "Manage and version your prompts in EvalSight. Edit and update them via the UI and SDK. Retrieve the production version via the SDKs. Learn more in the docs.",
    ...
    >
      {initialPrompt ? (
        <p className="text-muted-foreground text-sm">
          Prompts are immutable in EvalSight. To update a prompt, create a new
          version.
        </p>
      ) : null}
      <div className="my-8">
