  ...
  .superRefine((data, ctx) => {
    ...
    data.headers.forEach((header, index) => {
      ...
      if (WEB_CALLOUT_BLOCKED_HEADER_NAMES.has(lowerName)) {
        ctx.addIssue({
          code: "custom",
          message: "This header is set by EvalSight and cannot be customized.",
          path: ["headers", index, "name"],
        });
      }
    ...
    <Dialog open={props.open} onOpenChange={props.onOpenChange}>
      ...
      <DialogContent size="lg">
        <DialogHeader>
          ...
          <DialogDescription>
            EvalSight sends a backend JSON POST when a user clicks a web callout
            action.{" "}
            <a
              href="https://langfuse.com/docs/observability/features/web-callouts"
              target="_blank"
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      ...
                      is called from the EvalSight backend.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
